Pod::Spec.new do |spec|
    spec.name                     = 'nevisMobileAuthenticationSDKJs'
    spec.version                  = '3.3.0'
    spec.homepage                 = 'https://github.com/nevissecurity/nevis-mobile-authentication-sdk-js-package'
    spec.source                   = { :http => "https://github.com/nevissecurity/nevis-mobile-authentication-sdk-js-package/releases/download/v3.3.0/nevisMobileAuthenticationSDKJs.xcframework.zip"}
    ...
    spec.dependency 'nevis-mobile-authentication-sdk-ios-debug', '3.3.0.396', :configurations => ['Debug']
end
